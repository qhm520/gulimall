package com.qian.gulimall.product.aspect;
 ...
 * ProductSysLogAspect is 系统日志，切面处理类
 *
 * @author QIAN
 * Date 2020/04/19
 * Time 09:50
...
@Aspect
@Component
public class ProductSysLogAspect {
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        sysLog.setUsername((String) claims.get("user_name"));
