<template>
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    ...
    <!-- 弹窗, 修改密码 -->
    <main-navbar-update-password v-if="updatePassowrdVisible" ref="updatePassowrd"></main-navbar-update-password>
  </nav>
</template>

<script>
  import MainNavbarUpdatePassword from './MainNavbarUpdatePassword'
